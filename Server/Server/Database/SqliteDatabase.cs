// /*
//  * Copyright (c) 2025 Nico Philipp * Datei: SqliteDatabase.cs
//  */
...
{
    public class SqliteDatabase : ISchuldenbuchDatabase
    {
        private readonly SchuldenbuchContext _context;

        public SqliteDatabase(SchuldenbuchContext context)
        {
            _context = context;
        }
